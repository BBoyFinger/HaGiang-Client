      ...
      {!open && (
        <>
          <button
            ...
            className="fixed bottom-6 right-6 z-50 bg-blue-500 hover:bg-blue-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg focus:outline-none"
          ...
          <a
            ...
            className="fixed bottom-6 right-24 z-50 bg-white border border-blue-400 hover:bg-blue-50 rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition-all"
