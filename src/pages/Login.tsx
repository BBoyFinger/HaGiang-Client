  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="tiktok:title" content={t('login.title')} />
        <meta name="tiktok:description" content={t('login.description')} />
      ...
      <div className="bg-sky-100 flex justify-center items-center min-h-screen">
        <div className="flex w-full max-w-4xl mx-auto shadow-2xl rounded-2xl overflow-hidden">
          ...
          <div className="flex w-full lg:w-1/2 justify-center items-center">
            <div className="bg-white bg-opacity-95 rounded-none lg:rounded-r-2xl shadow-2xl p-10 max-w-md w-full h-full border border-gray-100">
